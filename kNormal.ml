...
let rec g env = function
  ...
  | Syntax.Add(e1, e2) ->
      let f x -> insert_let (g env e2) (fun y -> Add(x, y), Type.Int) in
  ...
  | Syntax.FAdd(e1, e2) ->
      let f x -> insert_let (g env e2) (fun y -> FAdd(x, y), Type.Float) in
      insert_let (g env e1) f
  | Syntax.FSub(e1, e2) ->
      let f x -> insert_let (g env e2) (fun y -> FSub(x, y), Type.Float) in
      insert_let (g env e1) f
  | Syntax.FMul(e1, e2) ->
      let f x -> insert_let (g env e2) (fun y -> FMul(x, y), Type.Float) in
      insert_let (g env e1) f
  | Syntax.FDiv(e1, e2) ->
      let f x -> insert_let (g env e2) (fun y -> FDiv(x, y), Type.Float) in
      insert_let (g env e1) f
